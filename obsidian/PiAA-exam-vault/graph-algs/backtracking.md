...
Задача о ферзях требует размещения N ферзей на доске N×N так, чтобы ни один из них не бил другого. Классическое решение использует backtracking (поиск с возвратом).
